...
public:
	...
	inline void addVelocity(const v3f &vel) { m_added_velocity += vel; }

	void setShadowIntensity(float intensity) { m_lighting.setShadowIntensity(intensity); }
	float getShadowIntensity() const { return m_lighting.getShadowIntensity(); }
